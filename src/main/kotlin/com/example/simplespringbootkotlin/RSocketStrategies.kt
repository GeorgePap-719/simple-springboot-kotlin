...
private class CustomProtobufEncoder(private val protobufSerializer: ProtoBuf) : Encoder<Any> {
...
private class CustomProtobufDecoder(private val protobufSerializer: ProtoBuf) : Decoder<Any> {
